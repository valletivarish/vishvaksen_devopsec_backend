...
public class ProductController {
    ...
    @GetMapping("/all")
    public ResponseEntity<List<ProductResponseDto>> getAllProductsIncludingDeleted() {
        List<ProductResponseDto> products = productService.getAllProductsIncludingDeleted();
        return ResponseEntity.ok(products);
    }
}
